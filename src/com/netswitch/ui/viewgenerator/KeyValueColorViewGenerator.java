...
public class KeyValueColorViewGenerator extends ViewGenerator{

	ViewHolder holder;

	public KeyValueColorViewGenerator(int resource) {
		super(resource);
	...
	public void populateView(Row item) {
		...
		holder.second.setBackgroundColor(item.color);
